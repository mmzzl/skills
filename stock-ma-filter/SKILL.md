...
# 默认筛选沪深300（金叉 + 多头排列）
py -3.12 ma_filter.py

# 筛选中证500
py -3.12 ma_filter.py --index zz500

# 筛选全A股
py -3.12 ma_filter.py --index all

# 只筛选金叉信号
py -3.12 ma_filter.py --signal golden_cross

# 只筛选多头排列
py -3.12 ma_filter.py --signal bullish_alignment

# 保存报告到文件
py -3.12 ma_filter.py -o report.txt

# 不使用AI分析
py -3.12 ma_filter.py --no-ai
```
